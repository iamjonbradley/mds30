...
echo '<div class="J0300-SKIP J0300-SKIP2">';
...
echo $this->Html->div('header', 'J0700. Should the Staff Assessment for Pain be Conducted?');
echo $form->input('SectionJ.J0700', array('label' => false, 'id' => 'J0700', 'type' => 'select', 'escape' => false, 'empty' => ' ', 'options' => array(
		0 => '0. No', 
		1 => '1. Yes',
	)));
echo '</div>';
echo '</div>';
echo '<div class="J0700-SKIP J0300-SKIP">';
...
echo $this->Html->div('header', 'J0850. Frequency of Indicator of Pain or Possible Pain <span class="normal">in the last 5 days</span>');
echo $this->Html->div('', 'Frequency with which resident complains or shows evidence of pain or possible pain');
echo $form->input('SectionJ.J0850', array('label' => false, 'id' => 'J0700', 'type' => 'select', 'escape' => false, 'empty' => ' ', 'options' => array(
