...
echo $form->input('SectionB.B0100', array('label' => 'Persistent vegetative state/no discernible consciousness', 'id' => 'B0100',  'type' => 'select',  'escape' => false, 'empty' => ' ', 'options' => array(
		0 => '0. No', 
...
echo $form->input('SectionB.B0200', array('label' => 'Ability to hear <span class="normal">(with hearing aid or hearing appliances if normally used)</span>', 'id' => 'B0200',  'type' => 'select',  'escape' => false, 'empty' => ' ', 'options' => array(
...
echo $form->input('SectionB.B0300', array('label' => 'Hearing aid or other hearing appliance used <span class="normal">in completing B0200, Hearing</span>', 'id' => 'B0300',  'type' => 'select',  'escape' => false, 'empty' => ' ', 'options' => array(
		0 => '0. No', 
		1 => '1. Yes', 
	)));
...
echo $form->input('SectionB.B0600', array('label' => 'Select best description of speech pattern', 'id' => 'B0600',  'type' => 'select',  'escape' => false, 'empty' => ' ', 'options' => array(
...
echo $form->input('SectionB.B0700', array('label' => 'Select best description of speech pattern', 'class' => 'B0700',  'type' => 'select',  'escape' => false, 'empty' => ' ', 'options' => array(
    0 => '0. Understood', 
...
echo $form->input('SectionB.B0800', array('label' => 'Understanding verable content, however able <span class="small">(with hearing aid or device if used)</span>', 'id' => 'B0800',  'type' => 'select',  'escape' => false, 'empty' => ' ', 'options' => array(
...
echo $form->input('SectionB.B1000', array('label' => 'Ability to see in adequate light <span class="small">(with glasses or other visual appliances)</span>', 'id' => 'B1000',  'type' => 'select',  'escape' => false, 'empty' => ' ', 'options' => array(
...
echo $form->input('SectionB.B1200', array('label' => 'Corrective Lenses (contacts, glasses, or magnifying glass) used <span class="normal">in completing B1000 Vision</span>', 'id' => 'B1200',  'type' => 'select',  'escape' => false, 'empty' => ' ', 'options' => array(
		0 => '0. No', 
		1 => '1. Yes', // skip to G0110
	)));
echo '</div>';
