...
echo $form->input('SectionA.A0050', array('label' => false, 'id' => 'A0050',  'type' => 'select', 'legend' => false, 'empty' => ' ', 'options' => array(
    1 => '1. Add new record', 
...
echo $form->input('SectionA.A1300A', array('label' => 'A. Medical Records #', 'maxLength' => 10, 'size' => 10, 'value' => $this->data['Resident']['PATNUM']));
echo $form->input('SectionA.A1300B', array('label' => 'B. Room #', 'maxLength' => 12, 'size' => 12, 'value' => $this->data['Resident']['ROOM']));
echo $form->input('SectionA.A1300C', array('label' => 'C. Name by which resident prefers to be addressed', 'maxLength' => 23, 'size' => 23));
echo $form->input('SectionA.A1300D', array('label' => 'D. Lifetime occupation(s) <span class="normal">- put "/" between two occupations</span>', 'maxLength' => 23, 'size' => 23, 'value' => $this->data['Resident']['OCCUPATION']));
...
echo $form->input('SectionA.A2200', array('label' => false, 'type' => 'text'));
