...
echo $form->input('SectionO.O0500C', array('div' => 'input text float-single', 'div' => 'input text float-single', 'label' => 'C. Splint or brace assistance', 'maxLength' => 1, 'size' => 1));
...
echo $form->input('SectionO.O0500I', array('div' => 'input text float-single', 'label' => 'I. Amputation/prostheses care', 'maxLength' => 1, 'size' => 1));
