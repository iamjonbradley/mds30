...
echo $form->input('SectionA.A1800', array( 'type' => 'select', 'label' => false, 'escape' => false, 'empty' => ' ', 'options' => array(
		'01' => '01. Community (home/apt., board/care, assisted living, group home)', 
...
echo $form->input('SectionA.A2200', array('label' => false, 'class' => 'A2200', 'div' => 'input text A2200','type' => 'text', 'between' => 'Format as YYYY-MM-DD <br />', 'maxLength' => 10, 'size' => 10));
