...
echo $this->Html->div('misc K0510C', 'C. Mechanically altered diet', array('style' => 'margin-left: 0;'));
...
echo $this->Html->div('misc K0510D', 'D. Therapeutic diet', array('style' => 'margin-left: 0;'));
...
echo $this->Html->div('misc K0510Z', 'Z. None of the above.', array('style' => 'margin-left: 0;'));
