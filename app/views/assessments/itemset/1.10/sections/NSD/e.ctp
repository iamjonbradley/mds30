...
echo $this->Html->div('header E0300', 'E0300. Overall Presence of behavioral Symptoms');
...
echo $this->Html->div('header E0500', 'E0500. Impact on Resident');
echo $this->Html->div('note E0500', '<img src="/img/icons/lightbulb.png" class="note-img" /> <strong>NOTE:</strong> Did any of the identified symptom(s)');
