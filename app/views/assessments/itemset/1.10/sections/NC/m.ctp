...
echo $this->Html->div('header M0100', 'M0100. Determination of Pressure Ulcer Risk');
echo $this->Html->div('note M0100', '<img src="/img/icons/lightbulb.png" class="note-img" /> <strong>NOTE:</strong> Check all that apply');
...
echo $this->Html->div('header M0150', 'M0150. Risk of Pressure Ulcers');
...
echo $this->Html->div('header M0210', 'M0210. Unhealed Pressure Ulcer(s)');
...
echo $this->Html->div('header M0700', 'M0700. Most Severe Tissue Type for Any Pressure Ulcer');
...
echo $this->Html->div('header M1030', 'M1030. Number of Venous and Arterial Ulcers');
...
echo $this->Html->div('header M1040', ' M1040. Other Ulcers, Wounds and Skin Problems');
echo $this->Html->div('note M1040', '<img src="/img/icons/lightbulb.png" class="note-img" /> <strong>NOTE:</strong> Check all that apply');
echo $this->Html->div('misc M1040', 'Foot Problems');
...
echo $this->Html->div('misc M1040', 'Other Problems');
...
echo $this->Html->div('misc M1040', 'None of the Above');
...
echo $this->Html->div('header M1200', 'M1200. Skin and Ulcer Treatments');
echo $this->Html->div('note M1200', '<img src="/img/icons/lightbulb.png" class="note-img" /> <strong>NOTE:</strong> Check all that apply');
