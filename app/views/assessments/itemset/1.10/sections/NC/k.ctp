...
echo $this->Html->div('header K0100', 'K0100. Swallowing Disorder <br /> <span class="normal">Signs and symptoms of possible swallowing disorder</span>');
echo $this->Html->div('note K0100', '<img src="/img/icons/lightbulb.png" class="note-img" /> <strong>NOTE:</strong> Check all that apply');
...
echo $this->Html->div('header K0200', 'K0200. Height and Weight - <span class="normal">While measuring, if the number is X.1 - X.4 round down; X.5 or greater round up</span>');
...
echo $this->Html->div('header K0300', 'K0300. Weight Loss');
...
echo $this->Html->div('header K0310', 'K0310. Weight Gain.');
...
echo '<div id="K0700">';
echo $this->Html->div('header K0700', 'K0700. Percent Intake by Artificial Route');
