  ...
  <tr>
    <td valign="top">
      ...
      <ol start="0">
        ...
        <li><strong>Supervision</strong> - oversight, oversight or cueing </li>
  ...
  <tr class="border-bottom">
    <td valign="top" class="bold border-left">
      <ol style="list-style-type: upper-alpha" start="10">
        <li>Personal hygiene - <span class="normal">how resident maintains personal hygiene, including combing hair, brushing teeth, shaving, applying makeup, washing/drying face and hands (excludes baths and showers)</span></li>
      </ul>
    </td>
...
echo $this->Form->input('SectionG.G0120A', array('legend' => 'A. Self Performance', 'id' => 'G0120A', 'type' => 'radio', 'escape' => false, 'empty' => ' ', 'options' => array(
...
echo $this->Form->input('SectionG.G0120B', array('legend' => 'B. Support provided','type' => 'radio', 'escape' => false, 'empty' => ' ', 'options' => $options[2]));
...
echo $this->Form->input('SectionG.G0300A', array('legend' => 'A. Moving from seated to standing position','type' => 'radio', 'escape' => false, 'empty' => ' ', 'options' => $options));
echo $this->Form->input('SectionG.G0300B', array('legend' => 'B. Walking <span class="normal">(with assistive device if used)</span>','type' => 'radio', 'escape' => false, 'empty' => ' ', 'options' => $options));
echo $this->Form->input('SectionG.G0300C', array('legend' => 'C. Turning around <span class="normal">and facing the opposite direction while walking</span>','type' => 'radio', 'escape' => false, 'empty' => ' ', 'options' => $options));
echo $this->Form->input('SectionG.G0300D', array('legend' => 'D. Moving on and off toilet','type' => 'radio', 'escape' => false, 'empty' => ' ', 'options' => $options));
*/
?>
</td>
...
<?php
/**
echo $this->Html->div('header', 'G0300. Balance During Transitions and Walking - continued');
echo $this->Form->input('SectionG.G0300E', array('legend' => 'E. Surface-to-surface <span class="normal">(transfer between bed and chair or wheelchair)</span>','type' => 'radio', 'escape' => false, 'empty' => ' ', 'options' => $options));
