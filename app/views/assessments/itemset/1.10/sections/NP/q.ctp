...
echo $this->Form->input('SectionQ.Q0490', array('id' => 'Q0490', 'label' => 'Does the resident\'s clinical record document a request that this question be asked only on comprehensive assessments?', 'type' => 'select', 'escape' => false, 'empty' => ' ', 'options' => array(
    0 => '0. No',
    1 => '1. Yes',
...
echo $this->Form->input('SectionQ.Q0550A', array('div' => 'input select Q0550A', 'label' => 'A. Does the resident (or family or significant other or guardian, if resident is unable to respond) want to be asked about returning to the community on all assessments? (Rather than only on comprehensive assessments.', 'type' => 'select', 'escape' => false, 'empty' => ' ', 'options' => array(
    0 => '0. No',
    1 => '1. Yes',
    8 => '8. Information not available.',
  )));
echo $this->Form->input('SectionQ.Q0550B', array('div' => 'input select Q0550B', 'label' => 'B. Indicate information source for Q0550A.', 'type' => 'select', 'escape' => false, 'empty' => ' ', 'options' => array(
    1 => '1. Resident',
