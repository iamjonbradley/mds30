...
echo $form->input('SectionH.H0500', array('label' => 'Is a toileting program currently being used to manage the resident\'s bowel continence?', 'id' => 'H0500',  'type' => 'select', 'legend' => false, 'escape' => false, 'empty' => ' ', 'options' => array(
		0 => '0. No', 
		1 => '1. Yes',
	)));
