...
echo $form->input('SectionO.O0500B', array('divdiv' => 'input text float-single', 'class' => 'input text float-single', 'label' => 'B. Range of motion (active)', 'maxLength' => 1, 'size' => 1));
...
echo $form->input('SectionO.O0500J', array('div' => 'input text float-single', 'class' => 'input text float-single', 'label' => 'J. Communication', 'maxLength' => 1, 'size' => 1));
