...
echo $this->Html->div('note', '<img src="/img/icons/lightbulb.png" class="note-img" /> <strong>NOTE:</strong> Check all that apply');
echo $form->input('SectionK.K0500A', array('label' => 'A. Parenteral/lV feeding', 'id' => 'K0500A', 'type' => 'checkbox'));
echo $form->input('SectionK.K0500B', array('label' => 'B. Feeding tube <span class="normal">- nasogastric or abdominal (PEG)</span>', 'id' => 'K0500B', 'type' => 'checkbox'));
echo $form->input('SectionK.K0500C', array('label' => 'C. Mechanically altered diet <span class="normal">- require change in texture of food or liquids (e.g., pureed food, thickened liquids)</span>', 'type' => 'checkbox'));
echo $form->input('SectionK.K0500D', array('label' => 'D. Therapeutic diet <span class="normal">(e.g., low salt, diabetic, low cholesterol)</span>', 'type' => 'checkbox'));
echo $form->input('SectionK.K0500Z', array('label' => 'Z. None of the above', 'type' => 'checkbox'));
