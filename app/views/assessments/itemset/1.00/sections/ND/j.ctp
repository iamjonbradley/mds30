...
echo $form->input('SectionJ.J0400', array('label' => '<span class="normal">Ask Resident</span> "How much of the time have you experianced pain or hurting <span class="normal">in the last 5 days?"</span>', 'id' => 'J0400', 'type' => 'select', 'escape' => false, 'empty' => ' ', 'options' => array(
...
echo $this->Html->div('', 'Ask Resident: <em>"Please rate the intesity of your worst pain over the last 5 days." (Show resident verbal scale)</em> (show');
...
echo $form->input('SectionJ.J0800A', array('label' => 'A. Non-verbal sounds <span class="normal">(crying, whining, gasping, moaning, or groining)</span>', 'type' => 'checkbox'));
...
echo $form->input('SectionJ.J1900C', array('label' => 'C. Major Injury - <span class="normal">bone fractures, joint dislocations, closed head injuries with altered conciousness, subdural hematoma</span>', 'id' => 'J1900C', 'type' => 'select', 'escape' => false, 'empty' => ' ', 'options' => array(
		0 => '0. None', 
		1 => '1. One',
		2 => '2. Two or more',
	)));
