...
echo $this->Form->input('SectionJ.J0100B', array('label' => 'B. received PRN pain medications?', 'id' => 'J0100B', 'type' => 'select', 'empty' => ' ', 'options' => array(0 => '0. No', 1 => '1. Yes')));
...
echo $this->Html->div(' J0600B', 'Ask Resident: <em>"Please rate the intesity of your worst pain over the last 5 days." (Show resident verbal scale)</em> (show');
...
echo $this->Html->div('header J0800', 'Staff Assessment for Pain');
echo $this->Html->div('header J0800', 'J0800. Indicators of Pain or Possible Pain <span class="normal">in the last 5 days</span>');
echo $this->Html->div('note J0800', '<img src="/img/icons/lightbulb.png" class="note-img" /> <strong>NOTE:</strong> Check all that apply');
echo $this->Form->input('SectionJ.J0800A', array('label' => 'A. Non-verbal sounds <span class="normal">(crying, whining, gasping, moaning, or groining)</span>', 'type' => 'checkbox'));
echo $this->Form->input('SectionJ.J0800B', array('label' => 'B. Vocal complaints of pain <span class="normal">(that hurts, ouch, stop)</span>', 'type' => 'checkbox'));
echo $this->Form->input('SectionJ.J0800C', array('label' => 'C. Facial expressions <span class="normal">(grimaces, winces, wrinkled forehead, furrowed brow, clenched teeth or jaw)</span>', 'type' => 'checkbox'));
echo $this->Form->input('SectionJ.J0800D', array('label' => 'D. Protective body movements or postures <span class="normal">(e.g., bracing, guarding, rubbing or massaging a body part/area, clutching or holding a body part during movement)</span>', 'type' => 'checkbox'));
echo $this->Form->input('SectionJ.J0800Z', array('label' => 'Z. None of these signs observed or documented', 'type' => 'checkbox'));
...
echo $this->Form->input('SectionJ.J0850', array('label' => false, 'id' => 'J0850', 'class' => 'J0850', 'type' => 'select', 'escape' => false, 'empty' => ' ', 'options' => array(
...
echo $this->Html->div('header J1300', 'J1300. Current Tobacco Use');
echo $this->Form->input('SectionJ.J1300', array('label' => false, 'id' => 'J0700', 'type' => 'select','escape' => false, 'empty' => ' ', 'options' => array(
		0 => '0. No', 
		1 => '1. Yes',
	)));
...
echo $this->Html->div('header', 'J1900. Number of Falls Since Admission or Prior Assesment (OBRA, PPS, or Discharge), <span class="normal">whichever is more recent</span>');
