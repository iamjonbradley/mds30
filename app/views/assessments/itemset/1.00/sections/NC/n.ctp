...
echo $this->Form->input('SectionN.N0350A', array('label' => 'Enter Days', 'maxLength' => 1, 'size' => 1));
...
echo $this->Form->input('SectionN.N0350B', array('label' => 'Enter Days', 'maxLength' => 1, 'size' => 1));
echo '</div>';
...
echo $this->Form->input('SectionN.N0400A', array('label' => 'A. Antipsychotic', 'type' => 'checkbox'));
echo $this->Form->input('SectionN.N0400B', array('label' => 'B. Antianxiety', 'type' => 'checkbox'));
echo $this->Form->input('SectionN.N0400C', array('label' => 'C. Antidepressant', 'type' => 'checkbox'));
echo $this->Form->input('SectionN.N0400D', array('label' => 'D. Hypnotic', 'type' => 'checkbox'));
echo $this->Form->input('SectionN.N0400E', array('label' => 'E. Anticoagulant <span class="normal">(warfarin, heparin, or low-molecular weight heparin)</span>', 'type' => 'checkbox'));
echo $this->Form->input('SectionN.N0400F', array('label' => 'F. Antibiotic', 'type' => 'checkbox'));
echo $this->Form->input('SectionN.N0400G', array('label' => 'G. Diuretic', 'type' => 'checkbox'));
echo $this->Form->input('SectionN.N0400Z', array('label' => 'Z. None of the above were received', 'type' => 'checkbox'));
