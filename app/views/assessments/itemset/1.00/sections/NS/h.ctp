...
echo $form->input('SectionH.H0500', array('select' => 'Is a toileting program currently being used to manage the resident\'s bowel continence?', 'id' => 'H0500',  'type' => 'select', 'escape' => false, 'empty' => ' ', 'options' => array(
		0 => '0. No', 
		1 => '1. Yes',
	)));
	
echo $this->Html->div('header', 'H0600. Bowel Patterns');
echo $form->input('SectionH.H0600', array('select' => 'Constipation present?', 'id' => 'H0600',  'type' => 'select', 'escape' => false, 'empty' => ' ', 'options' => array(
		0 => '0. No', 
		1 => '1. Yes',
	)));
?>
