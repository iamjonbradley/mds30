...
<?php
$A0310E = '';
echo $form->hidden('A0310E', array('value' => $this->data['SectionA']['A0310E'], 'id' => 'A0310E'));
...
echo $this->Html->div('header', 'Q0400. Discharge Plan - continued');
echo $form->input('SectionQ.Q0400B', array('id' => 'Q0400B', 'label' => 'B. What determination was made by the resident and the care planning team regarding discharge to the community', 'type' => 'select', 'escape' => false, 'empty' => ' ', 'options' => array(
