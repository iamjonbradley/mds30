...
echo $form->input('SectionX.X0100', array('label' => false, 'type' => 'select', 'id' => 'X0100', 'escape' => false, 'empty' => ' ', 'options' => array(
		1 => '1. Add new record',
...
echo $form->input('SectionX.X0200A', array('div' => 'input text float-left', 'label' => 'A. First name', 'maxLength' => 12, 'size' => 12, 'value' => $this->data['SectionA']['A0500A']));
echo $form->input('SectionX.X0200C', array('div' => 'input text float-left', 'label' => 'C. Last name', 'maxLength' => 18, 'size' => 18, 'value' => $this->data['SectionA']['A0500C']));
...
echo $form->input('SectionX.X0500', array('label' => false, 'maxLength' => 9, 'size' => 9, 'value' => str_replace('-', '', $this->data['Resident']['SSNUM'])));
