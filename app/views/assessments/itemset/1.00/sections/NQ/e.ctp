...
echo $form->input('SectionE.E0200A', array('label' => 'A. Physical behavioral symptoms directed toward others <span class="normal">(e.g., hitting, kicking, pushing, scratching, grabbing, abusing other sexual)</span>', 'id' => 'E0200A', 'type' => 'select', 'escape' => false, 'empty' => ' ', 'options' => $options));
...
echo $form->input('SectionE.E0200C', array('label' => 'C. Other behavioral sumptoms not directed toward others <span class="normal">(e.g., physical symptoms such as hitting or scratching self, pacing, rummaging, public sexual acts, disrobing in public, throwing or smearing food or bodily wastes, or verbal/vocal symptoms like screaming, disruptive sounds)</span>', 'id' => 'E0200C', 'type' => 'select', 'escape' => false, 'empty' => ' ', 'options' => $options));

// echo $this->Html->div('header', 'E0300. Overall Presence of behavioral Symptoms');

// $yesno = array(0 => '0. No', 1 => '1. Yes');
// echo $form->input('SectionE.E0300', array('id' => 'E0300', 'label' => 'Were any behavioral symptoms in questions E0200 coded 1, 2, 3', 'id' => 'E0300', 'type' => 'select', 'escape' => false, 'empty' => ' ', 'options' => $yesno));
...
// echo $form->input('SectionE.E0500A', array('id' => 'E0500A', 'label' => 'A. Put the resident at significant risk for physical illness or injury?', 'type' => 'select', 'escape' => false, 'empty' => ' ', 'options' => $yesno));
// echo $form->input('SectionE.E0500B', array('id' => 'E0500B', 'label' => 'B. Significantly interfere with resident\'s care?', 'type' => 'select', 'escape' => false, 'empty' => ' ', 'options' => $yesno));
// echo $form->input('SectionE.E0500C', array('id' => 'E0500C', 'label' => 'C. Significantly interfere with the resident\'s participation in activities or social interactions?', 'type' => 'select', 'escape' => false, 'empty' => ' ', 'options' => $yesno));
// echo '</div>';
...
echo $this->Html->div('note', '<img src="/img/icons/lightbulb.png" class="note-img" /> <strong>NOTE:</strong> Did any of the identified symptom(s)');
echo $form->input('SectionE.E0600A', array('label' => 'A. Put others at significant risk for physical injury?', 'type' => 'select', 'escape' => false, 'empty' => ' ', 'options' => $yesno));
echo $form->input('SectionE.E0600B', array('label' => 'B. Significantly intrude on the privacy or activity of others?', 'type' => 'select', 'escape' => false, 'empty' => ' ', 'options' => $yesno));
echo $form->input('SectionE.E0600C', array('label' => 'C. Significantly disrupt care or living environment?', 'type' => 'select', 'escape' => false, 'empty' => ' ', 'options' => $yesno));
echo '</div>';
*/
...
echo $form->input('SectionE.E1000A', array('label' => 'A. Does the wandering place the resident at significant risk of getting to a potentially dangerous place <span class="small">(e.g., stairs, outside of the facility)?', 'id' => 'E1000A', 'type' => 'select', 'escape' => false, 'empty' => ' ', 'options' => $yesno));
echo $form->input('SectionE.E1000B', array('label' => 'B. Does the wandering significantly intrude on the privacy or activities of others?', 'id' => 'E1000B', 'type' => 'select', 'escape' => false, 'empty' => ' ', 'options' => $yesno));
echo '</div>';
...
echo $form->input('SectionE.E1100', array('label' => 'How does resident\'s current behavior status, care rejection, or wandering <strong>compare to prior assessment (OBRA or PPS)</strong>?', 'id' => 'E1100', 'type' => 'select', 'escape' => false, 'empty' => ' ', 'options' => array(
		0 => '0. Same', 
		1 => '1. Improved',
		2 => '2. Worse',
