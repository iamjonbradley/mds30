...
echo $this->Html->div('misc', 'M. Isolation of quarantine for active infectious disease <span class="normal">(does not include standard body/fluid precaustions)</span>', array('style' => 'margin-left: 0;'));
...
echo $form->input('SectionO.O0250C', array('label' => 'A. If Influenza vaccine not received, state reason', 'type' => 'select', 'escape' => false, 'empty' => ' ', 'options' => array(
...
echo $form->input('SectionO.O0400A5', array('label' => 'A5. Therapy start date', 'div' => 'input date float-left', 'type' => 'text', 'between' => 'Format as YYYY-MM-DD <br />', 'maxLength' => 10, 'size' => 10));
echo $form->input('SectionO.O0400A6', array('label' => 'A6. Therapy end date', 'div' => 'input date float-left','type' => 'text', 'between' => 'Format as YYYY-MM-DD <br />', 'maxLength' => 10, 'size' => 10));
...
echo $form->input('SectionO.O0400B5', array('label' => 'B4. Therapy start date', 'div' => 'input date float-left', 'type' => 'text', 'between' => 'Format as YYYY-MM-DD <br />', 'maxLength' => 10, 'size' => 10));
echo $form->input('SectionO.O0400B6', array('label' => 'B5. Therapy end date', 'div' => 'input date float-left', 'type' => 'text', 'between' => 'Format as YYYY-MM-DD <br />', 'maxLength' => 10, 'size' => 10));
...
echo $form->input('SectionO.O0400C5', array('label' => 'C5. Therapy start date', 'div' => 'input date float-left', 'type' => 'text', 'between' => 'Format as YYYY-MM-DD <br />', 'maxLength' => 10, 'size' => 10));
echo $form->input('SectionO.O0400C6', array('label' => 'C6. Therapy end date', 'div' => 'input date float-left', 'type' => 'text', 'between' => 'Format as YYYY-MM-DD <br />', 'maxLength' => 10, 'size' => 10));
...
echo $form->input('SectionO.O0500A', array('label' => 'A. Range of motion (passive)', 'maxLength' => 1, 'size' => 1));
echo $form->input('SectionO.O0500B', array('label' => 'B. Range of motion (active)', 'maxLength' => 1, 'size' => 1));
echo $form->input('SectionO.O0500C', array('label' => 'C. Splint or brace assistance', 'maxLength' => 1, 'size' => 1));

echo $this->Html->div('header', 'Training and Skill Practice in:');
echo $form->input('SectionO.O0500D', array('label' => 'D. Bed mobility', 'maxLength' => 1, 'size' => 1));
echo $form->input('SectionO.O0500E', array('label' => 'E. Transfer', 'maxLength' => 1, 'size' => 1));
echo $form->input('SectionO.O0500F', array('label' => 'F. Walking', 'maxLength' => 1, 'size' => 1));
echo $form->input('SectionO.O0500G', array('label' => 'G. Dressing and/or grooming', 'maxLength' => 1, 'size' => 1));
echo $form->input('SectionO.O0500H', array('label' => 'H. Eating and/or swallowing', 'maxLength' => 1, 'size' => 1));
echo $form->input('SectionO.O0500I', array('label' => 'I. Amputation/prostheses care', 'maxLength' => 1, 'size' => 1));
echo $form->input('SectionO.O0500J', array('label' => 'J. Communication', 'maxLength' => 1, 'size' => 1));
