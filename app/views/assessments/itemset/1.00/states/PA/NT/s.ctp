...
echo $form->input('SectionS.S0123', array('label' => 'S0123. County Code of Prior Residence. <span class="normal">Enter the first five digits of the zip code</span>', 'type' => 'select', 'options' => $counties_pa, 'empty' => '(select a county code )'));
