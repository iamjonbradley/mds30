...
class CareTrackerTask extends Shell {
   ...
   */
  public function execute ($function, $id) {
   ...
   * @return $headers array header information for the soap request
   */
  public function resident_submit ($id = null) {
  ...
  public function _sendRequest ($function, $id) {
    ...
    $this->out('Pushed '. $function .' Facility # '. $id .' to Care Tracker');
